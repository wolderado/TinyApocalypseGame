...
RLAPI Image GenImageSmoothWhiteNoise(int width, int height, float factor);                               // Generate image: smooth white noise
...
RLAPI void ImageGrayscaleCrop(Image* image, float threshold);                                            // Crop image depending on alpha value
...
RLAPI Rectangle GetImageGrayscaleBorder(Image image, float threshold);                                   // Get image alpha border rectangle
...
RLAPI void DrawCubeRotated(Texture texture,Vector3 position, float width, float height, float length, float angle, Vector3 axis, Color color);    // Draw cube rotated
RLAPI void DrawCubeRotatedAngle(Texture texture, Vector3 position, float width, float height, float length, float angleX, float angleY, float angleZ, Color color);    // Draw cube rotated by angle
RLAPI void DrawCubeRotatedOneSidedTexture(Texture texture, Vector3 position, float width, float height, float length, float angle, Vector3 axis, Color color);    // Draw cube rotated
...
RLAPI void DrawFlippedPlane(Vector3 centerPos, Vector2 size, Color color);                               // Draw a plane XZ Flipped with normal
RLAPI void DrawPlaneTexture(Texture2D texture, Vector3 position, float width, float length, Color color);            // Draw a plane XZ with texture
